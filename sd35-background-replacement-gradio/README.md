# Stable Diffusion 3.5 Background Replacement in Gradio
Gradio demo of background replacement using [Stable Diffusion 3.5 Large inpainting](../sd35-inpainting-gradio/)

### Screenshot
![screenshot_background_replacement.png](./images/screenshot_background_replacement.png)

#### Input Image
![screenshot_background_replacement.png](./images/example_input_background_replacement.png)
...
3. Clone this repo to your machine and change into the directory for the [sd35-inpainting-gradio](../sd35-inpainting-gradio/) demo:
   ```
