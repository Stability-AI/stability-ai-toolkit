# InstantX Stable Diffusion 3.5 Large IP-Adapter in Gradio
Gradio demo of [InstantX Stable Diffusion 3.5 Large IP-Adapter](https://huggingface.co/InstantX/SD3.5-Large-IP-Adapter) using Stable Diffusion 3.5 Medium
